    ...
    <TopsterContainer>
      ...
      }
      {
        ...
        new Array(12).fill(1).map((_, index) => {
          return <TopsterAlbumBox 
          topsterAlbum={selectedTopster.albums.find(album => album.position === index + 11)} 
          key={index + 11} 
      ...
      }
      {
        ...
        new Array(20).fill(1).map((_, index) => {
          return <TopsterAlbumBox 
          topsterAlbum={selectedTopster.albums.find(album => album.position === index + 23)} 
          key={index + 23} 
      ...
      }
      {
        ...
        new Array(12).fill(1).map((_, index) => {
          return <TopsterAlbumBoxSkeletion
          width={'12.2vw'}
          key={index + 11}></TopsterAlbumBoxSkeletion>
        })
      }
      {
        getTopsterLoading && 
        new Array(20).fill(1).map((_, index) => {
          return <TopsterAlbumBoxSkeletion
          width={'7.08vw'}
          key={index + 23}></TopsterAlbumBoxSkeletion>
        })
      }
    </TopsterContainer>
  );
