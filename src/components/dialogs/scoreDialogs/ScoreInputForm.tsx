...
const ScoreInputForm: React.FC<propsType> = ({scoreVaildateText, handleChangeScore}) => {
  return (
    <ScoreBox>
      <GrScorecard size={24}></GrScorecard>
      <ScoreText>나의 점수는?</ScoreText>
      <ScoreInputBox>
        <Score placeholder='점수를 입력해 주세요.' min={1} max={100} type="number" name='score' onChange={handleChangeScore}></Score>
